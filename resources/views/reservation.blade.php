...
@section('content')
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Reserver une salle et un chef cuisinier</div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form method="POST" action="{{ route('reservation.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-2">
                                <label for="provider_id">Chef cuisinier</label>
                            ...
                            <div class="form-group mt-2">
                                <label for="number_places">Nombre de participants</label>
